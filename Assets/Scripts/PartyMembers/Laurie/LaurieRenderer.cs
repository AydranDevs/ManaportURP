...
namespace Manapotion.PartySystem.LaurieCharacter
{
    public class LaurieRenderer
    {
        ...
        public void Update() 
        {
            ...
            else if (_laurieController.movementDirection.Equals(new Vector2(1, 1)))
            { // northeast
                facingState = 0; 
            }
            else if (_laurieController.movementDirection.Equals(new Vector2(1, 0)))
            { // east
                facingState = 1; // east
            }
            else if (_laurieController.movementDirection.Equals(new Vector2(1, -1)))
            ...
            else if (_laurieController.movementDirection.Equals(new Vector2(0, -1)))
            { // south
                facingState = 2; // south
            }
            else if (_laurieController.movementDirection.Equals(new Vector2(-1, -1))) 
