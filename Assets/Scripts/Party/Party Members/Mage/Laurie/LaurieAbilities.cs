...
namespace Manapotion.PartySystem.LaurieCharacter
{
    public class LaurieAbilities
    {
        ...
        public LaurieAbilities(Laurie laurie)
        {
            ...
            // abilityCooldown = _laurie.stats.manaport_stat_ability_cooldown.GetValue(); // Sets cooldown time to whatever CooldownLimit is set to
        }
        ...
        public void Update()
        {
            ...
            if (abilityCooldown <= 0f) 
            {
                ...
                // abilityCooldown = _laurie.stats.manaport_stat_ability_cooldown.GetValue();  
            }
            else
            {
